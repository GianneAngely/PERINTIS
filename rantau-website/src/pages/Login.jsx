    ...
    <div className="min-h-screen bg-gradient-to-br from-[#0f1f16] via-[#0a1410] to-[#050a08] flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-md">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center gap-2 cursor-pointer">
                <input
                  type="checkbox"
                  className="w-4 h-4 rounded border-white/20 bg-white/5 text-forest-main focus:ring-forest-pale focus:ring-offset-0"
                />
        ...
        <p className="text-center text-gray-500 text-sm mt-8">
          By continuing, you agree to RANTAU's{" "}
          <Link
            to="/terms"
            className="text-forest-pale hover:text-forest-light transition-colors"
          >
            Terms of Service
          </Link>{" "}
          and{" "}
