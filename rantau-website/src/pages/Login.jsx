      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="bg-white rounded-3xl shadow-2xl p-6 sm:p-8 lg:p-10 border border-gray-100">
          <div className="text-center mb-8">
            <div className="inline-block bg-forest-main/10 px-4 py-2 rounded-full mb-4">
              <span className="text-forest-main font-semibold text-sm">
                SELAMAT DATANG KEMBALI
              </span>
            </div>
            <h1 className="font-heading text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900 mb-2">
              Masuk ke <span className="text-forest-main">RANTAU</span>
            </h1>
            <p className="text-gray-600">
              Lanjutkan perjalanan perantauan Anda
            </p>
          </div>
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center gap-2 cursor-pointer">
                <input
                  ...
                  className="w-4 h-4 rounded border-gray-300 text-forest-main focus:ring-forest-main"
                />
                <span className="text-sm text-gray-600">Ingat saya</span>
              </label>
              <Link
                to="/forgot-password"
                className="text-sm text-forest-main hover:text-forest-dark font-semibold"
              >
                Lupa password?
              </Link>
            </div>
